...
public class EV3Machine extends MotorMachine implements AutoCloseable
{
	...
	@Override
	public void close() {
		for (EV3LargeRegulatedMotor ev3LargeRegulatedMotor : motors) {
	...
	public static void main(String[] args) {
		...
		try (EV3Machine ev3Machine = new EV3Machine()) {
